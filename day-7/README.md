# Study context limitations. Demonstrate React Context performance problem with 1000 items, then fix with Zustand. Standup.
...
| **বৈশিষ্ট্য** | **React Context পদ্ধতি** | **Zustand পদ্ধতি** |
| --- | --- | --- |
| **প্রতি টাইপিং-এ রি-রেন্ডার** | **১,০০০টি কম্পোনেন্ট** রি-রেন্ডার হয় | **মাত্র ১টি কম্পোনেন্ট** রি-রেন্ডার হয় |
| **কনসোল লগ** | প্রতি অক্ষরে ১,০০০টি লগ | প্রতি অক্ষরে মাত্র ১টি লগ |
| **ইউজার এক্সপেরিয়েন্স (UI)** | টাইপ করার সময় ল্যাগ বা আটকে যাবে | সুপার স্মুথ (60 FPS) পারফরম্যান্স |
| **কাজের ধরন** | পুরো কম্পোনেন্ট ট্রিতে চেকিং চালায় | সাবস্ক্রিপশন (Selector) মেকানিজমে চলে |